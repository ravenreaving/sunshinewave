...
<html lang="en">
 ...
 <form action="g_eventplan.php" method="POST" id="cplan">
  
  <!-- set event details -->
  
 <div class="modal fade" id="setplan" role="dialog">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Event Plan</h4>
        </div>
		
        <div class="modal-body">
         <label for="paxcount"><p strong>How many guest will participate in the event? <br> Example: 100 Pax</p></label>
		<input required type="number" name="paxcount" id="paxcount" class="form-control" placeholder="Minimum of <?php echo $minpax ?> Maximum of <?php echo $maxpax ?> in this Package" min="<?php echo$minpax?>" max="<?php echo $maxpax?>" required><br>

		<label for="ev_venue"><p strong>What Venue do you want to use? </p></label>
		<select class="form-control" name="p_ev_venue" id="p_ev_venue">
		<option value="Function Hall">Function Hall</option>
		<option value="Garden Venue">Garden Venue</option>
		</select><br>
		
		<label for="dishcount"><p> <strong>Number of Main Course. <br>Main Courses: Pork, Beef, Fish, Vegetable, Dessert</p></strong></label>
		<input type="text" name="ccount" id="ccount" class="form-control" value="<?php echo $cater ?> Main Course" readonly><br>
		<input type="hidden" name="course_count" id="course_count" value="<?php echo $cater ?>">
	
		<label for="event_type"><p> <strong>Event Type:</p></strong></label>
		<input type="text" name="p_event_type" id="p_event_type" class="form-control" value="<?php echo $evtype ?>" readonly><br>
	
		<label for="event_title"><p strong>What is the Title of your Event?</p></label>
		<input required type="text" name="p_event_title" id="p_event_title" class="form-control" placeholder="Example: Birthday Party / Jons Birthday" required><br>
        </div>
...
<!-- event plan summary  
  <div class="modal fade" id="myplan" role="dialog">
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <ul>
		<li><p>Total Guest Count:<input type="text" name="paxcount" id="paxcount" class="form-control" readonly  value=""></p></li>
		<li><p>Number of Main Course:<input type="text" name="course_count" id="course_count" class="form-control" readonly  value=""></p></li>
		<li><p>Event Type:<input type="text" name="ev_type" id="ev_type" class="form-control" readonly  value=""></p></li>
		<li><p>Event Venue:<input type="text" name="ev_venue" id="ev_venue" class="form-control" readonly  value=""></p></li>
			<li><p>Event Title:<input type="text" name="ev_title" id="ev_title" class="form-control" readonly  value=""></p></li>
 ...
 --> 
            ...
            <div class="error-content">
              <span>Event Package Plan</span>
              <p>Please set your event plan details first</p>
	
              <div class="price-footer">

			 <sup class="price-up"> <button type="button" class="btn btn-danger pull-center" data-toggle="modal" data-target="#setplan"><i class="fa fa-tags"></i> <strong>Set Event Plan Details </strong> </button></sup>
...
<textarea name="maintotal" id="maintotal" class="pull-left" cols="15" rows="1" value="<?php echo $price ?>" readonly><?php echo $price ?></textarea>
...
<sup class="price-up"> <button type="button" class="purchase-btn pull-right" data-toggle="modal" data-target="#menurem"> <strong>Reminder</strong> <i class="fa fa-ticket"></i></button></sup>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <ul>
		<li><p><strong>Note: The 300 per pax price is not only base in the menu.</strong></p></li>
		  <li><p>1. You can choose any dish in the "Main Course Menu"</p></li>
	<li><p>2. You can only choose 6 dish as per say in the package.</p></li>
		  </ul>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
echo '     <ul> 
  ...
  <li align="left"><input type="checkbox"  id="'.$row['menuid'].'" name="menu" value="'.$row['price'].'" onclick="calculate()" > 
	<label id="main'.$row['menuid'].'" for="'.$row['menuid'].'">'.$row['menuname'].' </label>
	</li></div> 
...
$("input[name=total_charge]").val(total_charge);
 ...
 <!-- Modal -->
  <div class="modal fade" id="totalrem" role="dialog">
    ...
    <div class="col-md-12 col-sm-6 col-xs-12">                  
  <li>
	<p class="pull-left"><strong>Price Per Pax:</strong><input type="text" disabled name="cater_total"  size="25" value="<?php echo $price ?>"> </p> &nbsp;
