	...
	if(isset($_POST['login']))
{
	if(isset($_POST['uname']) && $_POST['pword'])
	{
		...
		if(!empty($id))
		{
			...
			header("Location: g_packages.php?guestid=$id");
		}
		else
		{
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="title-area">
			...
			<button type="button" class="btn btn-default btn-md" data-toggle="modal" data-target="#login-form"><i class="fa fa-pencil-square"></i> <strong>Create Own Package</strong></button>	
          </div>
        </div>
  ...
  echo ' <div class="modal fade" id="'.$row['packid'].'freebies" role="dialog">
              ...
              <div class="single-team-member">
                ...
                <article class="blog-news-single">
                  ...
                  <div class="blog-news-title">
				   ...
				   <p>Maximum of:<strong> '.$row['minpax'].' Pax</strong> </p>
				   <p>Maximum of:<strong> '.$row['maxpax'].' Pax</strong></p>
				   <p>Catering:<strong> '.$row['cater'].'</strong> </p> 
	...
	<button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#packageinfo"><i class="fa fa-exclamation"></i> Read Me</button>
				 ...
				 <div class="team-member-link">
                   <a href="#" data-target="#login-form" data-toggle="modal" ><i class="fa fa-hand-pointer-o"> PLAN EVENT  </i></a>   
                 </div>
              </div>
			  </div>';
}
